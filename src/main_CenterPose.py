...
# python main_CenterPose.py --load_model ../models/CenterPose/cereal_box_v1_140.pth 
...
def main(opt):
    ...
    #         print(k)
    #         print(batch[k])
    #     img=np.array(batch["input"][0])
    #     img=np.moveaxis(img, 0, -1)
    #     plt.imshow(img)
    #     plt.show()
    #     hm=np.array(batch["hm"][0][0])
    #     print(hm.shape)
    #     hm=np.moveaxis(hm, 0, -1)
    #     plt.imshow(hm)
    #     plt.show()
    #     hm_hp=np.array(batch["hm_hp"][0][0])
    #     print(hm_hp.shape)
    #     hm_hp=np.moveaxis(hm_hp, 0, -1)
    #     for i in range(0,8):
    #         plt.imshow(hm_hp[:,:,i])
    #         plt.show()
    #     return
